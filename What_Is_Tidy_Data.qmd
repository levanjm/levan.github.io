...
kable(weather_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin-right:auto;'")
```
...
kable(grades_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
...
kable(sales_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(health_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(financial_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(sports_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(ratings_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(salary_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(reviews_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(enrollment_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(sales2_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(survey_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(weather2_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(exam_scores, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(hospital_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(marketing_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(fitness_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(financial2_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(attendance_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
...
kable(production_data, format = "html", table.attr = "style='width:4in; margin-left:auto; margin.right:auto;'")  %>%
  kable_styling(position="center")
```
